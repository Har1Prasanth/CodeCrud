...
public class CustomerServiceImpl implements CustomerService {
	...
	/*
	 * @Override public List<CustomerBean>
	 * findAllCustomersByBillAmountBetween(double i, double j) {
	 * 
	 * return customerDAOWrapper.findAllCustomersByBillAmountBetween(i, j); }
	 * 
	 * @Override public List<CustomerBean>
	 * findAllCustomersBycustomerNameStartsWith() { // TODO Auto-generated method
	 * stub return customerDAOWrapper.findAllCustomersBycustomerNameStartsWith(); }
	 */
